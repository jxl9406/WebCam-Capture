...
while True:
    ...
    #COLOR_BGR2GRAY apply for all pixels
    gray_frame_gau = cv2.GaussianBlur(gray_frame, (21, 21), 0)

    #In first iteration, framme is none, then frame will get gray_frame_gau
    ...
    for contour in contours:
        #if image just slight change(area < 5000), not a real object(area > 5000)
